...
import com.innovations.djnig.truecallerclone.MmsConfig;
                ...
                switch (type) {
                    ...
                    case MESSAGE_TYPE_NOTIFICATION_IND: {
                        ...
                        if (NotificationTransaction.allowAutoDownload(mContext)) {
                            ...
                            Intent svc = new Intent(TransactionService.TRANSACTION_COMPLETED_ACTION,
                            ...
                            Intent notificationBroadcast = new Intent(NOTIFY_OF_MMS);
