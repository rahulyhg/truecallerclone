...
public class RemoteMessagingReceiver extends BroadcastReceiver {
    ...
    public static NotificationCompat.Action getReplyAction(Context context, String address, long threadId) {
        ...
        Set<String> defaultResponses = new HashSet<>(Arrays.asList(context.getResources().getStringArray(R.array.pref_example_list_titles)));
        Set<String> responseSet = prefs.getStringSet("pref_key_qk_responses", defaultResponses);
